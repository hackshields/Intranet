...
$APPLICATION->SetTitle("Business Processes");
?>
<div> Contents:
  <ul>
 ...
 <img border="1" title="Documents and statuses" alt="Documents and statuses" src="#SITE_DIR#images/bp/1.png" />
  ...
  <p><img border="1" alt="Example: simple linear process" title="Example: simple linear process" src="#SITE_DIR#images/bp/2.png" /></p>
 ...
 <img border="1" alt="Example: process with statuses" title="Example: process with statuses" src="#SITE_DIR#images/bp/3.png" />
  ...
  certain document type by clicking <img src="#SITE_DIR#images/bp/4.png" alt="Business processes button" title="Business processes button" />
  ,which will open the <b>Business Process Templates</b> page where you can edit
  existing and create new processes.
  <p>
 <img border="1" src="#SITE_DIR#images/bp/11.png" alt="Business processes page" title="Business processes page" />
  ...
  process.</p>
 <img border="1" title="Setting process parameters" alt="Setting process parameters" src="#SITE_DIR#images/bp/6.png" />
  ...
  process.</p>
   <img border="1" src="#SITE_DIR#images/bp/7.png" alt="Assigning actions in statuses" title="Assigning actions in statuses" />
 ...
 <img border="1" title="Adding actions in the visual editor" alt="Adding actions in the visual editor" src="#SITE_DIR#images/bp/8.png" />
 ...
 <img border="1" src="#SITE_DIR#images/bp/5.png" alt="Launching a business process for a document" title="Launching a business process for a document" />
  <p>When a business process parameters window opens, specify the parameters and
  click <b>Start</b>.</p>
 <img border="1" title="Setting up a business process" alt="Setting up a business process" src="#SITE_DIR#images/bp/9.png" />

...
$APPLICATION->SetTitle("Microsoft Outlook Two-Way Integration");
?>
<script type="text/javascript" src="#SITE_DIR#bitrix/templates/learning/js/imgshw.js"></script>
<p>Bitrix24 implements two-way integration with Microsoft Outlook.
...
<table border="0" cellspacing="1" cellpadding="1" width="100%">
  <tbody>
    <tr><td valign="top"><img hspace="10" src="#SITE_DIR#images/docs/cp/bullet-n.gif" width="12" height="15" /><a href="#my_kalendar" >synchronize
        personal calendars</a>
        <br />
      <img hspace="10" src="#SITE_DIR#images/docs/cp/bullet-n.gif" width="12" height="15" /><a href="#company_calendar" >synchronize
        company calendars</a>
        <br />
      <img hspace="10" src="#SITE_DIR#images/docs/cp/bullet-n.gif" width="12" height="15" /><a href="#useful" >synchronize
        personal contacts</a>
        <br />
      <img hspace="10" src="#SITE_DIR#images/docs/cp/bullet-n.gif" width="12" height="15" /><a href="#kalendars" >export
        multiple calendars</a>
        <br />
      <img hspace="10" src="#SITE_DIR#images/docs/cp/bullet-n.gif" width="12" height="15" /><a href="#kalendars" >view
        calendars in a common grid in MS Outlook</a>
        <br />
      <img hspace="10" src="#SITE_DIR#images/docs/cp/bullet-n.gif" width="12" height="15" /><a href="#useful1" >synchronize
        personal tasks</a>
      </td><td>
        <br />
      </td><td valign="top">
...
<?$APPLICATION->IncludeComponent("bitrix:main.include", ".default", array(
	"AREA_FILE_SHOW" => "file",
	"PATH" => "#SITE_DIR#services/help/outlook_inc.php",
	"EDIT_TEMPLATE" => ""
	),
	false
);?>
...
<div align="center">
  <table style="BORDER-COLLAPSE: collapse" border="0" cellspacing="1" cellpadding="1">
    <tbody>
      <tr><td>
          <div align="center"><a href="javascript:ShowImg('#SITE_DIR#images/docs/big/outlook.png', 600, 413, 'Adding an employee')"><img title="Adding an employee" border="0" alt="Adding an employee" src="#SITE_DIR#images/docs/outlook_sm.png" width="300" height="207" /> </a>
            <br />
          </div>
...
<div align="center">
  <table style="BORDER-COLLAPSE: collapse" border="0" cellspacing="1" cellpadding="1">
    <tbody>
      <tr><td>
          <div align="center"><a href="javascript:ShowImg('#SITE_DIR#images/docs/big/outlook_3.png', 509, 449, 'Calendar description')"><img title="Calendar description" border="0" alt="Calendar description" src="#SITE_DIR#images/docs/outlook_3_sm.png" /> </a>
            <br />
          </div>
...
<div align="center">
  <table style="BORDER-COLLAPSE: collapse" border="0" cellspacing="1" cellpadding="1">
    <tbody>
      <tr><td>
          <div align="center"><a href="javascript:ShowImg('#SITE_DIR#images/docs/big/outlook_4.png', 709, 575, 'Calendar has been added to Outlook!')"><img title="Calendar has been added to Outlook!" border="0" alt="Calendar has been added to Outlook!" src="#SITE_DIR#images/docs/outlook_4_sm.png"  /> </a>
            <br />
          </div>
...
<div align="center">
  <table style="BORDER-COLLAPSE: collapse" border="0" cellspacing="1" cellpadding="1">
    <tbody>
      <tr><td>
          <div align="center"><a href="javascript:ShowImg('#SITE_DIR#images/docs/big/outlook_5.png', 709, 575, 'Export calendar(s) to Outlook')"><img title="Export calendar(s) to Outlook" border="0" alt="Export calendar(s) to Outlook" src="#SITE_DIR#images/docs/outlook_5_sm.png"  /> </a>
            <br />
          </div>
...
<div align="center"><a href="javascript:ShowImg('#SITE_DIR#images/docs/big/outlook_9.png',452,272,'New Event in the Calendar')"> <img height="150" border="0" width="249" src="#SITE_DIR#images/docs/outlook_9_sm.png" title="Click to Enlarge" style="cursor: pointer;" /></a></div>
...
<div align="center">
  <div align="center"><a href="javascript:ShowImg('#SITE_DIR#images/docs/big/outlook_13.png', 600, 413, 'Synchronize personal tasks')"><img title="Synchronize personal tasks" border="0" alt="Synchronize personal tasks" src="#SITE_DIR#images/docs/outlook_13_sm.png" width="400" height="276" /> </a>
    <br />
  </div>

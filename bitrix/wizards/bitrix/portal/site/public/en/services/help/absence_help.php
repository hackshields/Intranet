...
$APPLICATION->SetTitle("Planning the Events");
?>
<script type="text/javascript" src="/bitrix/templates/learning/js/imgshw.js"></script>
Planning a meeting and cracking your head over proper time to be convenient for your colleagues? The Portal is your best scheduling help! Any employee can be invited whose status is other than <b>Away</b>:
<ul>
  <li>Start by creating a new calendar event. Click <b>Add</b> and select <b>event in scheduler</b>:

<p><img height="236" border="0" width="328" src="#SITE_DIR#images/docs/event_plan1.png" /></p>

<p>This will open the event scheduler form:</p>

<p><img height="496" border="0" width="704" src="#SITE_DIR#images/docs/event_plan.png" /></p>
...
<p><img height="387" border="0" width="532" src="#SITE_DIR#images/docs/new_personal_absence.png" /></p>
</li>
...
<p><img height="294" border="0" width="853" src="#SITE_DIR#images/docs/graph.png" /></p>

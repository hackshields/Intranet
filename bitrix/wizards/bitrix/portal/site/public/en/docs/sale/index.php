...
$APPLICATION->SetTitle("Sales and Marketing");
?>

<?$APPLICATION->IncludeComponent("bitrix:webdav", ".default", Array(
	"IBLOCK_TYPE"	=>	"library",
	"IBLOCK_ID"	=>	"#SALES_FILES_IBLOCK_ID#",
	"BASE_URL"	=>	"#SITE_DIR#docs/sale/",
	...
	"STR_TITLE"	=>	"Sales and Marketing",
	"UPLOAD_MAX_FILESIZE"	=>	"1024",
	"UPLOAD_MAX_FILE"	=>	"4",
	"SET_TITLE"	=>	"Y",
	"DISPLAY_PANEL"	=>	"N",
	"USE_COMMENTS" => "Y", 
	"FORUM_ID" => "#SALE_FILES_FORUM_ID#", 

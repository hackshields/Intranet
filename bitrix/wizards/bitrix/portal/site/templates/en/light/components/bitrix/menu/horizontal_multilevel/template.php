...
foreach($arResult as $key => $arItem):
	...
	?><span class="root-item<?if ($arItem["SELECTED"]):?> selected<?endif;?>"<?if (array_key_exists("ITEMS", $arItem) && count($arItem["ITEMS"]) > 0):?> onclick="BX.PortalTopMenu.itemOnclick(this, event)" ontouchstart="BX.PortalTopMenu.itemTouchStart(this, event)" onmouseover="BX.PortalTopMenu.itemOver(this)" onmouseout="BX.PortalTopMenu.itemOut(this)"<?endif?>><a href="<?=$arItem["LINK"]?>"><span class="left-corner"></span><span class="root-item-text"><span class="root-item-text-line"><?=$arItem["TEXT"]?></span></span><span class="right-corner"></span></a><?

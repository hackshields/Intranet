...
<div class="sidebar-links">
		<a id="excelUserExport" href="<?=$APPLICATION->GetCurPageParam('current_view=table&excel=yes'.(!empty($arFilterValues[$arParams['FILTER_NAME'].'_LAST_NAME']) ? htmlspecialcharsbx('&'.$arParams['FILTER_NAME'].'_LAST_NAME='.$arFilterValues[$arParams['FILTER_NAME'].'_LAST_NAME']) : ''), array('excel', 'current_view', $arParams['FILTER_NAME'].'_LAST_NAME'))?>" onclick="javascript:void(0)" title="<?echo GetMessage('INTR_COMP_IS_TPL_TOOLBAR_EXCEL_TITLE')?>"><i class="sidebar-action-excel"></i><b><?echo GetMessage('INTR_COMP_IS_TPL_TOOLBAR_EXCEL')?></b></a><span></span>

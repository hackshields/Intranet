...
?>
	...
	<div class="department-profile-events">
		...
		<div class="department-profile-events-cont">
			<?if($USER->CanDoOperation('bitrix24_invite') && CModule::IncludeModule('bitrix24')):
			$arInviteParams["UF_DEPARTMENT"] = $current_section;?>
			<a class="department-profile-events-item department-profile-add-sub" href="javascript:void(0)" onclick="<?=CBitrix24InviteDialog::ShowInviteDialogLink($arInviteParams)?>"><i></i><?=GetMessage("INTR_IS_TPL_ACTION_INVITE")?></a>
			<?endif;        

...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("ABSENCE_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/desktop.php", array("ABSENCE_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/company/absence.php", array("ABSENCE_IBLOCK_ID" => $iblockID));
?>
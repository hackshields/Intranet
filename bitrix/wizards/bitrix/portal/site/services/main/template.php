...
if(WIZARD_TEMPLATE_ID=="light")
{
	...
	if (WIZARD_USE_SITE_LOGO)
	{
		...
		{
			copy(WIZARD_ABSOLUTE_PATH ."/site/templates/".LANGUAGE_ID."/light/themes/".WIZARD_THEME_ID."/images/logo.jpg", $_SERVER['DOCUMENT_ROOT']."/include/default_logo.".$rnd.".jpg");
...
//		$arTemplates[]= Array("CONDITION" => "CSite::InDir('".WIZARD_SITE_DIR."m/')", "SORT" => 151, "TEMPLATE" => "cp_mobile_".WIZARD_SITE_ID);
	...
	if (!$foundEmpty && $allowGuests <> "Y")
		$arTemplates[]= Array("CONDITION" => "!\$GLOBALS['USER']->IsAuthorized() && \$_SERVER['REMOTE_USER']==''", "SORT" => 250, "TEMPLATE" => "empty");
...
// for b24	
	if (WIZARD_TEMPLATE_ID === "bitrix24" && $current_template !== "bitrix24" && WIZARD_FIRST_INSTAL == "Y")
	{
		CopyDirFiles(
...
if (WIZARD_TEMPLATE_ID === "bitrix24")
	...
	COption::SetOptionString("main", "wizard_template_id", WIZARD_TEMPLATE_ID.'_'.WIZARD_THEME_ID, false, WIZARD_SITE_ID);
?>
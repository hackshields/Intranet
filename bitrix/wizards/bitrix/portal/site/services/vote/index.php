...
if (!$rsVoteChan->Fetch()){
	...
	$arFieldsVote = array(
		...
		"ACTIVE"			=> "'Y'",
		"TIMESTAMP_X"		=> $DB->GetNowFunction(),
		"DATE_START"		=> $DB->CharToDateFunction(GetTime(mktime(14,59,59,8,23,2009),"FULL")),
		"DATE_END"			=> $DB->CharToDateFunction(GetTime(mktime(23,59,57,9,23,2010),"FULL")),
	...
	$arFieldsVote = array(
		...
		"ACTIVE"			=> "'Y'",
		"TIMESTAMP_X"		=> $DB->GetNowFunction(),
		"DATE_START"		=> $DB->CharToDateFunction(GetTime(mktime(23,59,59,9,23,2010),"FULL")),
		"DATE_END"			=> $DB->CharToDateFunction(GetTime(mktime(23,59,59,9,23,2013),"FULL")),

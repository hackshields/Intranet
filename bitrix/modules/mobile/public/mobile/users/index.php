...
<?$APPLICATION->IncludeComponent("bitrix:socialnetwork.user_profile", "mobile", array(
		"PATH_TO_USER" => "/mobile/users/?user_id=#user_id#",
		"PATH_TO_GROUP" => "/mobile/?group_id=#group_id#",
		"PATH_TO_MESSAGES_CHAT" => "/mobile/im/dialog.php?id=#user_id#",
		'PATH_TO_TASKS_SNM_ROUTER' => '/mobile/tasks/snmrouter/'

...
if (!isset($arParams['PREFIX_FOR_PATH_TO_SNM_ROUTER']))
	$arParams['PREFIX_FOR_PATH_TO_SNM_ROUTER'] = '/mobile/tasks/snmrouter/';

$snmRouterPath = $arParams['PREFIX_FOR_PATH_TO_SNM_ROUTER'];

$arComputedParams = array(
	'PATH_TO_SNM_ROUTER'        => $snmRouterPath . '?routePage=#ROUTE_PAGE#&USER_ID=#USER_ID#',
	'PATH_TO_SNM_ROUTER_AJAX'   => '/bitrix/components/bitrix/mobile.tasks.detail/ajax.php',

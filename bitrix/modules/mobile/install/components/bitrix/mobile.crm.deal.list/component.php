...
$contactID = $arResult['CONTACT_ID'] = isset($_GET['contact_id']) ? intval($_GET['contact_id']) : 0;
...
$arResult['SERVICE_URL'] = SITE_DIR.'bitrix/components/bitrix/mobile.crm.deal.list/ajax.php?siteID='.SITE_ID.'&'.bitrix_sessid_get();
//<-- NEXT_PAGE_URL, SEARCH_PAGE_URL, SERVICE_URL

...
$arResult['FILTER_PRESETS'] = array(
	'filter_new' => array('name' => GetMessage('M_CRM_LEAD_LIST_PRESET_NEW'), 'fields' => array('STAGE_ID' => array('NEW'))),
...
//$arResult['SERVICE_URL'] = SITE_DIR.'bitrix/components/bitrix/mobile.crm.lead.list/ajax.php?siteID='.SITE_ID.'&'.bitrix_sessid_get();

...
SetTab : function(tabId, bFirst, P)
{
	...
	var
		...
		tblDis = BX.browser.IsIE() ? 'inline' : 'table';
...
BuildDayCell : function(date, day, bCurMonth, month, year)
{
	...
	{
		var D = _this.activeDateDaysAr[parseInt(BX.findParent(this, {tagName: 'table', className: 'bxec-daytbl'}).parentNode.id.substr(9))];
...
{
	oDay.id = 'bxec_ind_' + this.activeDateDaysAr.length;

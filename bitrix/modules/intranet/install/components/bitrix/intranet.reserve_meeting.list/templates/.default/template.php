...
else
{
	...
	<?
	$p = '/bitrix/components/bitrix/intranet.reserve_meeting.list/js/dialogs.js';
	$GLOBALS['APPLICATION']->AddHeadString('<script type="text/javascript" src="'.$p.'?v='.filemtime($_SERVER['DOCUMENT_ROOT'].$p).'"></script>', true);
	?>

...
$arGadgetParams["PATH_TO_GENERAL"] = (isset($arGadgetParams["PATH_TO_GENERAL"])?$arGadgetParams["PATH_TO_GENERAL"]:"/company/personal/");
...
$arGadgetParams["PATH_TO_PHOTO_NEW"] = (isset($arGadgetParams["PATH_TO_PHOTO_NEW"])?$arGadgetParams["PATH_TO_PHOTO_NEW"]:"/company/personal/user/#user_id#/photo/photo/user_#user_id#/0/action/upload/");
...
$arGadgetParams["PATH_TO_TASK_NEW"] = (isset($arGadgetParams["PATH_TO_TASK_NEW"])?$arGadgetParams["PATH_TO_TASK_NEW"]:"/company/personal/user/#user_id#/tasks/task/create/0/");
...
<ul>
	...
	<li><a href="<?=CComponentEngine::MakePathFromTemplate($arGadgetParams["PATH_TO_SUBSCR"], $p)?>"><?echo GetMessage("GD_PROFILE_SUBSCR")?></a>

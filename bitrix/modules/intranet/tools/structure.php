...
?>
	<script type="text/javascript">
		...
		var myButtons = myBX.IntranetStructure.popup.buttons;
		var myTitle = myBX.IntranetStructure.popup.titleBar;
		<?if(isset($arParams["UF_DEPARTMENT_ID"]) || $_POST['CURRENT_DEPARTMENT_ID']):?>
			myButtons[0].setName('<?echo GetMessage("INTR_STRUCTURE_EDIT")?>');
			myTitle.innerHTML = '<span><?echo GetMessage("INTR_EDIT_TITLE")?></span>';
		<?elseif ($ID > 1):?>
			myButtons[0].setName('<?echo GetMessage("INTR_STRUCTURE_ADD_MORE")?>');
			myTitle.innerHTML = '<span><?echo GetMessage("INTR_ADD_TITLE")?></span>';
		<?else:?>
			myButtons[0].setName('<?echo GetMessage("INTR_STRUCTURE_ADD")?>');
			myTitle.innerHTML = '<span><?echo GetMessage("INTR_ADD_TITLE")?></span>';
		<?endif?>

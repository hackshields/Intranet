...
<div class="feed-workday-table"><?
	?><span class="feed-workday-left-side"><?
		?><span class="feed-workday-table-text"><?=GetMessage("REPORT_FROM")?>:</span> <span class="feed-workday-avatar"<?=(strlen($arParams["USER"]["PHOTO"]) > 0 ? " style=\"background:url('".$arParams["USER"]["PHOTO"]."') no-repeat center center #FFFFFF\"" : "")?>></span><?
	...
	?><span class="feed-workday-right-side"><?
		?><span class="feed-workday-table-text"><?=GetMessage("REPORT_TO")?>:</span> <span class="feed-workday-avatar"<?=(strlen($arParams["MANAGER"]["PHOTO"]) > 0 ? " style=\"background:url('".$arParams["MANAGER"]["PHOTO"]."') no-repeat center center #FFFFFF\"" : "")?>></span><?

...
GO
ALTER TABLE B_TIMEMAN_ENTRIES ADD CONSTRAINT FK_B_TIMEMAN_ENTRIES_USER_ID FOREIGN KEY (USER_ID) REFERENCES B_USER(ID)
GO
...
GO
CREATE INDEX IX_B_TIMEMAN_REPORT_DAILY_1 ON B_TIMEMAN_REPORT_DAILY (USER_ID)
GO

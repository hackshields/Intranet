...
if (is_array($arPresetFilters))
{
	...
	{
		if (array_key_exists("EXACT_EVENT_ID", $arResult["PresetFilters"][$preset_filter_id]["FILTER"]))
		{
			$arParams["EXACT_EVENT_ID"] = $arResult["PresetFilters"][$preset_filter_id]["FILTER"]["EXACT_EVENT_ID"];
			$bGetComments = false;
		}

				...
				?><div class="feed-comments-block" id="feed_comments_block_<?=$arEvent["EVENT"]["ID"]?>" style="display: <?=(intval($arEvent["COMMENTS_COUNT"]) > 0 ? "block" : "none")?>"><?
					...
					)
					{
						?><div class="feed-com-header">
							<div class="feed-com-all"><a href="javascript:void(0);" onclick="__logComments(<?=$arEvent["EVENT"]["ID"]?>, <?=intval($arResult["LAST_LOG_TS"] + $arResult["TZ_OFFSET"])?>, <?=($arEvent["EVENT"]["FOLLOW"] != "N" ? "true" : "false")?>);"><span class="feed-com-all-text"><?=GetMessage("SONET_C30_ALL_COMMENTS")?></span><span class="feed-comments-all-count"> (<span id="feed-comments-all-cnt-<?=$arEvent["EVENT"]["ID"]?>"><?=intval($arEvent["COMMENTS_COUNT"])?></span>)</span><span class="feed-comments-all-hide" style="display: none;"><?=GetMessage("SONET_C30_ALL_COMMENTS_HIDE")?></span></a><i></i></div>
						</div>

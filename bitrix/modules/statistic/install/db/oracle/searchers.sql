...
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (1,1,'','find_keywords',null)
/
...
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (2,2,'%google.%','q','UTF-8')
/
...
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (3,3,'ya.ru','holdreq, text','Windows-1251')
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (4,3,'yandex.ru','holdreq, text','Windows-1251')
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (5,3,'tovar.yandex.ru','holdreq, text','Windows-1251')
/
...
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (6,4,'%.rambler.ru','old_q, words','Windows-1251')
/
...
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (7,5,'go.mail.ru','q','Windows-1251')
/
insert into b_stat_searcher (ID,SAVE_STATISTIC,NAME,USER_AGENT,DIAGRAM_DEFAULT,CHECK_ACTIVITY) values (6,'Y','Aport','Aport','Y','N')
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (8,6,'sm.aport.ru','r','Windows-1251')
/
insert into b_stat_searcher (ID,SAVE_STATISTIC,NAME,USER_AGENT,DIAGRAM_DEFAULT,CHECK_ACTIVITY) values (7,'Y','MSN','MSNBot','Y','N')
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (9,7,'msn.com','MT','UTF-8')
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (10,7,'search.msn.com','q','UTF-8')
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (11,7,'auto.search.msn.com','q','UTF-8')
/
...
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (12,8,'search.yahoo.com','p','UTF-8')
/
...
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (13,9,'%altavista.com','q','UTF-8')
/
insert into b_stat_searcher (ID,SAVE_STATISTIC,NAME,USER_AGENT,DIAGRAM_DEFAULT,CHECK_ACTIVITY) values (10,'Y','AOL','','Y','N')
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (14,10,'search.aol.com','query','UTF-8')
/
insert into b_stat_searcher (ID,SAVE_STATISTIC,NAME,USER_AGENT,DIAGRAM_DEFAULT,CHECK_ACTIVITY) values (11,'Y','NIGMA','','Y','N')
/
insert into b_stat_searcher_params (ID,SEARCHER_ID,DOMAIN,VARIABLE,CHAR_SET) values (15,11,'www.nigma.ru','s','UTF-8')
/
...
/
CREATE SEQUENCE SQ_B_STAT_SEARCHER START WITH 217 INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/
DROP SEQUENCE SQ_B_STAT_SEARCHER_PARAMS
/
CREATE SEQUENCE SQ_B_STAT_SEARCHER_PARAMS START WITH 16 INCREMENT BY 1 NOMAXVALUE NOCYCLE NOCACHE NOORDER
/

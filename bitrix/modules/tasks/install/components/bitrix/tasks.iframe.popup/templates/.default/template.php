...
{
	CUtil::InitJSCore(array('popup','tooltip', 'taskQuickPopups'));
	...
	$arPopupOptions = CUserOptions::GetOption('tasks', 'popup_options', array('opened_description' => 'N'));
	...
	BX.message({
		...
		TASKS_TASK_NUM          : "<?php echo GetMessage("TASKS_TASK_NUM")?>",
		TASKS_TITLE_EDIT_TASK   : "<?php echo GetMessage("TASKS_TITLE_EDIT_TASK")?>",
		TASKS_TITLE_CREATE_TASK : "<?php echo GetMessage("TASKS_TITLE_CREATE_TASK")?>",

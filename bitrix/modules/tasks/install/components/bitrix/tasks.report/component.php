...
if ($_GET["F_FILTER"] == "Y")
{
	...
	$_SESSION["FILTER"]["F_DATE_TYPE"] = $_GET["F_DATE_TYPE"];
	$_SESSION["FILTER"]["F_DATE_DAYS"] = $_GET["F_DATE_DAYS"];
	$_SESSION["FILTER"]["F_DATE_FROM"] = $_GET["F_DATE_FROM"];
	$_SESSION["FILTER"]["F_DATE_TO"] = $_GET["F_DATE_TO"];
	$_SESSION["FILTER"]["F_DEPARTMENT_ID"] = $_GET["F_DEPARTMENT_ID"];
	$_SESSION["FILTER"]["F_GROUP_ID"] = $_GET["F_GROUP_ID"];
	$_SESSION["FILTER"]["F_RESPONSIBLE_ID"] = $_GET["F_RESPONSIBLE_ID"];
}
else
{
	...
	elseif ($arParams["USER_ID"] != $USER->GetID())
	{
...
$rsReports = CTaskReport::GetList($arOrder, $arFilter);

$rsReports->NavStart(intval($arParams["ITEMS_COUNT"]) > 0 ? $arParams["ITEMS_COUNT"] : 10);

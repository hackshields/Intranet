...
)
{
	...
	else
	{
		...
		{
			$message = str_replace("#TASK_DECLINE_REASON#", $arParams['TASK']["DECLINE_REASON"], $message);
			$message_24 = str_replace("#TASK_DECLINE_REASON#", $arParams['TASK']["DECLINE_REASON"], $message_24);
		}
	}

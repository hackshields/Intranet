...
class CFile extends CAllFile
{
	...
	function DoInsert($arFields)
	{
		...
		$strSql =
			"INSERT INTO b_file(ID, HEIGHT, WIDTH, FILE_SIZE, CONTENT_TYPE, SUBDIR, FILE_NAME, MODULE_ID, ORIGINAL_NAME, DESCRIPTION, HANDLER_ID) ".
			"VALUES('".$NEW_IMAGE_ID."', '".intval($arFields["HEIGHT"])."', '".intval($arFields["WIDTH"])."', '".intval($arFields["FILE_SIZE"])."', '".

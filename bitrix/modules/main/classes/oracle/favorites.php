		...
		if (is_array($arFilter))
		{
			foreach ($arFilter as $key => $val)
			{
				...
				case "LANGUAGE_ID":
					...
					break;
				case "DATE1":
					$arSqlSearch[] = "F.TIMESTAMP_X >=TO_DATE('".FmtDate($val,"D.M.Y")." 00:00:00','dd.mm.yyyy hh24:mi:ss')";
					break;
				case "DATE2":
					$arSqlSearch[] = "F.TIMESTAMP_X <=TO_DATE('".FmtDate($val,"D.M.Y")." 23:59:59','dd.mm.yyyy hh24:mi:ss')";
					break;
				case "MODIFIED":

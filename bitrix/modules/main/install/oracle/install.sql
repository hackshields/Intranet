...
(
	...
	FORMAT_DATE VARCHAR2(50 CHAR) NOT NULL,
	FORMAT_DATETIME VARCHAR2(50 CHAR) NOT NULL,
	FORMAT_NAME VARCHAR2(255 CHAR),
...
(
	...
	DIRECTION char(1 CHAR) default 'Y' not null,
	CULTURE_ID number(18),
	primary key (LID)
)
/
...
(
	...
	TO_CLASS VARCHAR2(50 CHAR) NULL,
	TO_METHOD VARCHAR2(50 CHAR) NULL,
...
/
CREATE INDEX IX_USER_OPTION_USER ON B_USER_OPTION (USER_ID)
/
...
CREATE TABLE b_group_subordinate(
	ID number(18) not null,
	AR_SUBGROUP_ID varchar2(255 CHAR) not null,
	primary key (ID)
)
/
...
CREATE TABLE B_RATING_COMPONENT (
	...
	CLASS VARCHAR2(512 CHAR) not null,
	CALC_METHOD VARCHAR2(512 CHAR) not null,
	EXCEPTION_METHOD VARCHAR2(512 CHAR) null,
	LAST_MODIFIED date null,
	LAST_CALCULATED date null,
...
CREATE TABLE B_SMILE (
	...
	IMAGE_HR CHAR(1 CHAR) default 'N' not null,

...
GO
CREATE INDEX IX_B_USER_OPTION ON B_USER_OPTION(CATEGORY, NAME)
GO
...
(
	...
	CALC_METHOD varchar(256) NOT NULL,
	EXCEPTION_METHOD varchar(256) NULL,
	LAST_MODIFIED datetime NULL,
	LAST_CALCULATED datetime NULL,
...
GO
ALTER TABLE B_SMILE ADD CONSTRAINT DF_B_SMILE_IMAGE_HR DEFAULT 'N' FOR IMAGE_HR
GO

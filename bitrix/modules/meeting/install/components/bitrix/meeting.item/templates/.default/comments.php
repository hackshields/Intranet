...
{
	BX.loadCSS('/bitrix/components/bitrix/forum.comments/templates/.default/style.css');
	BX.loadScript('/bitrix/js/forum/popup_image.js');
	BX.loadScript('/bitrix/components/bitrix/forum.comments/templates/.default/script_deferred.js');
}
else
{

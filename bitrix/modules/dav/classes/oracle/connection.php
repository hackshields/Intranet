	...
	extends CAllDavConnection
{
	public static function Add($arFields)
	{
		...
		$id = intval($DB->NextID("SQ_B_DAV_CONNECTIONS"));

		$strSql =
			"INSERT INTO b_dav_connections (ID, ".$arInsert[0].", CREATED, MODIFIED) ".
			"VALUES(".$id.", ".$arInsert[1].", ".$DB->CurrentTimeFunction().", ".$DB->CurrentTimeFunction().")";

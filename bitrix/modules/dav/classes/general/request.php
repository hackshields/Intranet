...
class CDavRequest
{
	private $arRequestParameters = null;

	private $agent = null;
	private $isUrlRequired = false;
	private $isRedundantNamespaceDeclarationsRequired = false;

	private $uri = "";		// complete URI for this request
	private $baseUri = "";	// base URI for this request
	private $path = "";		// URI path for this request

	private $depth = 0;
	private $arContentParameters = null;

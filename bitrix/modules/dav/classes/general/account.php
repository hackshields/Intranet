...
class CDavAccount
{
	...
	private static function GetAddressbookExtranetUserFilter($siteId, $arFilter)
	{
		if (CModule::IncludeModule('extranet') && CExtranet::IsExtranetSite($siteId))
		{
	...
	public static function GetAddressbookContactsList($collectionId, $arFilter = array())
	{
		...
		$arSelect = array(
				'FIELDS' => array(
					'ID', 'LOGIN', 'NAME', 'LAST_NAME', 'EMAIL', 'PERSONAL_BIRTHDAY', 'PERSONAL_PHOTO',

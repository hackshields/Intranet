...
abstract class CDavExchangeClient
{
	...
	protected function FormatRecurrenceFieldsArray($key, $value, &$arFields)
	{
		...
		switch ($key)
		{
			case "RecurringType":
				$bProcessed = true;
				$ar = array("none" => "NONE", "monthly_absolute" => "MONTHLY_ABSOLUTE", "monthly_relative" => "MONTHLY_RELATIVE", "yearly_absolute" => "YEARLY_ABSOLUTE", "yearly_relative" => "YEARLY_RELATIVE", "weekly" => "WEEKLY", "daily" => "DAILY");

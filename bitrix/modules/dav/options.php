...
$arTZ = CDavICalendarTimeZone::GetTimezoneList();

$arAllOptions1 = array(
	array("timezone", GetMessage("DAV_TIMEZONE"), "Europe/Moscow", array("selectbox", $arTZ)),
);
...
$arAllOptions = array_merge($arAllOptions1, $arAllOptions2, $arAllOptions3, $arAllOptions4);
...
foreach($arAllOptions1 as $arOption)

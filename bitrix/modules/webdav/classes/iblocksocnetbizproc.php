	...
	*/
	...
	function GetUserGroups($documentType = null, $documentId = null, $userId = 0)
	{
		...
		elseif ($arParameters["OwnerType"] == "user")
		{
			...
			if (CSocNetUserRelations::IsFriends2($userId, $arParameters["OwnerId"]))
	...
	*/
	...
	public function GetAllowableUserGroups($documentType)
	{
		...
		if ($res[2] == "user")
		{
			...
			$arResult[SONET_RELATIONS_TYPE_FRIENDS2] = GetMessage("WD_USER_GROUPS_FRIEND2");

function WDFileDialog(arParams)
{
...
WDFileDialog.prototype.Init = function()
{
...
WDFileDialog.prototype.getID = function() {
	return ('' + new Date().getTime()).substr(6);
}

WDFileDialog.prototype._addUrlParam = function(url, param)
{
	if (!url)
		return null;
...
WDFileDialog.prototype.BindLoadedFileControls = function(agent, id)
{
	this.AddUploadedFileActions(id);
}

WDFileDialog.prototype.ShowUploadedFile = function(agent)
{
...
/*	if(!agent.uploadResultArr){
	...
	if (!!agent.uploadResult.files)
	{
		...
		for (var ii in agent.uploadResult.files) {
			...
			if (agent.uploadResult.files[ii] && agent.uploadResult.files[ii]["content_type"])
			{
...
WDFileDialog.prototype.ShowMovedFile = function(element_id, arProp, section_path)
{
...
WDFileDialog.prototype._fileUnserialize = function(index)
{
...
WDFileDialog.prototype._fileSerialize = function(arFile)
{
	var arIndex = [ arFile.id, arFile.section, arFile.iblock ];
	return arIndex.join('|');
}

WDFileDialog.prototype.AddUploadedFileActions = function(element_id)
{
	if (isNaN(parseInt(element_id)) || (element_id <= 0))
		return false;
...
WDFileDialog.prototype.WDFD_SelectFolder = function(tab, path, selected, folderByPath)
{
	var id = false;
...
WDFileDialog.prototype.WDFD_CheckFileName = function(name)
{
...
WDFileDialog.prototype.WDFD_selectItem = function(element, itemID, name)
{
...
WDFileDialog.prototype.WDFD_unSelectItem = function(name)
{
	if (this.noticeTimeout) {
		clearTimeout(this.noticeTimeout);
		this.noticeTimeout = null;
...
WDFileDialog.prototype.WDFD_OpenSection = function(link, name)
{
	if (name == this.dialogName) {
...
WDFileDialog.prototype.WDFD_SelectFile = function(tab, path, selected)
{
	for (i in selected) {
...
WDFileDialog.prototype.MoveUploadedFile = function(element_id, name)
{
...
WDFileDialog.prototype.StopUpload = function(agent, p)
{
	var parent = p;
...
WDFileDialog.prototype.UploadDialogEvents = function(dialog)
{
...
WDFileDialog.prototype.ShowSelectDialog = function()
{
	this.h_WDFD_OpenSection = BX.proxy(this.WDFD_OpenSection, this);
...
WDFileDialog.prototype.Disable = function()
{
	BX.cleanNode(this.controller);
	this.controller.innerHTML = this.msg.access_denied;
}

WDFileDialog.prototype.GetUploadDialog = function(agent)
{
	this.agent = agent;
	this.LoadUploadDialog();
}

WDFileDialog.prototype.LoadUploadDialog = function()
{
...
WDFileDialog.prototype.LoadSelectDialog = function()
{
...
WDFileDialog.prototype.LoadDialogs = function(dialogs)
{
	if (!!this.agent)
	{
...
/*************************************************
                    DISPATCHER
**************************************************/
WDFileDialogDispatcher = function(controller, id)
{
...
WDFileDialogDispatcher.prototype.ExpandUploader = function()
{
	BX.onCustomEvent(BX(this.controller.parentNode), "WDLoadFormController");
	BX.removeCustomEvent(this.dropbox, 'dragEnter', this.hExpandUploader);
}

WDFileDialogDispatcher.prototype.Unbind = function()
{
	BX.removeCustomEvent(this.dropbox, 'dragEnter', this.hExpandUploader);
}

WDFileDialogDispatcher.items = {};
			...
			this.popup = new BX.PopupWindow('bx-wufd-preview-img-' + this.id, this.img,
				{
					...
					content : BX.create("img", { props: {src: this.img.src}})
				}
			);
			this.popup.show();
		}

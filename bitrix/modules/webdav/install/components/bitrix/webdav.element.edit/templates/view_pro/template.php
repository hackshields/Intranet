...
if (!$this->__component->__parent || $this->__component->__parent->__name != "bitrix:webdav"):
	...
	$GLOBALS['APPLICATION']->AddHeadString('<script src="/bitrix/components/bitrix/webdav/templates/.default/script.js"></script>');
endif;
$GLOBALS['APPLICATION']->AddHeadString('<script src="/bitrix/js/main/utils.js"></script>', true);
$GLOBALS['APPLICATION']->AddHeadString('<script src="/bitrix/js/main/public_tools.js"></script>', true);
...
";
	...
	if ($arResult["USERS"][$arResult["ELEMENT"]["CREATED_BY"]]['ID'] > 0)
	{
		ob_start();
		$APPLICATION->IncludeComponent("bitrix:main.user.link",
			...
			array(
				...
				"SECOND_NAME" => $arResult["USERS"][$arResult["ELEMENT"]["CREATED_BY"]]["SECOND_NAME"],
	...
	if (($arResult["ELEMENT"]["MODIFIED_BY"] == $arResult["ELEMENT"]["CREATED_BY"]) &&
		($arResult["ELEMENT"]["DATE_CREATE"] == $arResult["ELEMENT"]["TIMESTAMP_X"]))
	{
		...
		if ($arResult["USERS"][$arResult["ELEMENT"]["MODIFIED_BY"]]['ID'] > 0)
		{
		ob_start();
		$APPLICATION->IncludeComponent("bitrix:main.user.link",
			'',
	...
	{
		$aTagLinks[] = "<a href=\"javascript:void(0);\" onclick=\"WDSearchTag('".urlencode(CUtil::JSEscape(trim($sTag)))."')\">".trim($sTag)."</a>";
	}

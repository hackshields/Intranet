...
$jscript = CUtil::GetAdditionalFileURL($this->GetFolder().'/script_deferred.js');
?>
<script>
BX(function() {
	if (! BX.cur_page)
	...
	BX.loadCSS('/bitrix/components/bitrix/main.interface.form/templates/.default/style.css');
	setTimeout(function() {
		BX.loadScript("<?=$jscript?>", function() {

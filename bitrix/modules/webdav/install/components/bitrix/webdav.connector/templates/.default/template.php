...
?>
	...
	<div id="wd_winxp_wfolder_help" class="wd-collapseable">
		<? include $_SERVER['DOCUMENT_ROOT'] . $this->__folder . "/help/" . LANGUAGE_ID . "/help_webfolders.php"; ?>
	</div>
<?
	// Network Drive
...
?>
		...
		<div class="wd-collapseable" id="wd_winxp_ndrive_help">
			<? include $_SERVER['DOCUMENT_ROOT'] . $this->__folder . "/help/" . LANGUAGE_ID . "/help_mapdrive.php"; ?>
		</div>
<?
...
<!-- TODO: its not a link -->
	...
	<div class="wd-collapseable" id="wd_macos_help">
		<? include $_SERVER['DOCUMENT_ROOT'] . $this->__folder . "/help/" . LANGUAGE_ID . "/help_osx.php"; ?>
	</div>
<?
}

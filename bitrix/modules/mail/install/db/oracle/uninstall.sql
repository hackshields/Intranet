...
/
DROP SEQUENCE sq_b_mail_mailbox
/
DROP table b_mail_filter
/
DROP SEQUENCE sq_b_mail_filter
/
DROP table b_mail_filter_cond
/
DROP SEQUENCE sq_b_mail_filter_cond
/
DROP table b_mail_message
/
DROP SEQUENCE sq_b_mail_message
/
DROP table b_mail_message_uid
/
DROP table b_mail_msg_attachment 
/
DROP SEQUENCE sq_b_mail_msg_attachment
/
DROP table b_mail_spam_weight
/
DROP table b_mail_log 
/
DROP SEQUENCE sq_b_mail_log
/
